...
namespace Foundation.Models.Core.EnumModels
{
    ...
    /// <seealso cref="IEquatable{IStatus}" />
    [DependencyInjectionTransient]
    public class Status : EnumModel, IStatus, IEquatable<IStatus>
    {
        ...
        /// <returns></returns>
        private Boolean InternalEquals(IStatus? right)
        {
