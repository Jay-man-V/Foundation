...
namespace Foundation.Models.Core.EnumModels
{
    ...
    /// <seealso cref="IEquatable{IApprovalStatus}" />
    [DependencyInjectionTransient]
    public class ApprovalStatus : EnumModel, IApprovalStatus, IEquatable<IApprovalStatus>
    {
        ...
        public override Boolean Equals(Object? obj)
        {
            ...
            if (obj is IApprovalStatus approvalStatus)
            {
                retVal = InternalEquals(approvalStatus);
            }
        ...
        /// <returns></returns>
        private Boolean InternalEquals(IApprovalStatus? right)
        {
