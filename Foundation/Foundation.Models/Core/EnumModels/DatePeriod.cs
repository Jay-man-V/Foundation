...
namespace Foundation.Models.Core.EnumModels
{
    ...
    public class DatePeriod : FoundationModel, IDatePeriod, IEquatable<IDatePeriod>
    {
        ...
        public Boolean Equals(IDatePeriod? other)
        {
        ...
        public override Boolean Equals(Object? obj)
        {
            ...
            if (obj is DatePeriod DatePeriod)
            {
                retVal = InternalEquals(DatePeriod);
            }
        ...
        /// <returns></returns>
        private Boolean InternalEquals(IDatePeriod? right)
        {
