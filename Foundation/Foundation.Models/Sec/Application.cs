...
namespace Foundation.Models.Sec
{
    ...
    public class Application : FoundationModel, IApplication, IEquatable<IApplication>
    {
        ...
        public new AppId Id
        {
            ...
            {
                _id = value;
                base.Id = new EntityId(value.TheAppId);
            }
        }
        ...
        public override Boolean Equals(Object? obj)
        {
            ...
            {
                retVal = InternalEquals(application);
            }
        ...
        /// <returns></returns>
        private Boolean InternalEquals(IApplication? right)
        {
            Boolean retVal = base.InternalEquals(right);

            if (right != null)
            {
                retVal &= EqualityComparer<AppId>.Default.Equals(this.Id, right.Id);
