...
namespace Foundation.ViewModels.Main
{
    ...
    public class MainWindowViewModel : ViewModel, IMainWindowViewModel
    {
        ...
        /// </value>
        public ICommand ReShowLastExceptionErrorDialogCommand
        {
            get { return RelayCommandFactory.New(ReShowLastExceptionErrorDialog_Click, () => LastException != null); }
        }
        ...
        {
            get { return RelayCommandFactory.New<IMenuItem>(OnSave_Click, () => _enabled); }
        }
        ...
        private void OnShowAboutDialog_Click()
        {
            ...
            using (MouseCursor)
            {
                ...
                AboutSplashScreenFormViewModel viewModel =
                    new AboutSplashScreenFormViewModel(Core, RunTimeEnvironmentSettings, DateTimeService, WpfApplicationObjects, false);
