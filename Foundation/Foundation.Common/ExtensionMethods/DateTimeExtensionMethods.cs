...
namespace Foundation.Common
{
    ...
    public static class DateTimeExtensionMethods
    {
        ...
        extension(DateTime currentValue)
        {
            ...
            /// <returns></returns>
            public DateTime ToTimeZone(String targetTimeZone)
            {
            ...
            /// </returns>
            public Boolean IsBetween(DateTime startValue, DateTime endValue)
            {
        ...
        extension(DateTime currentValue)
        {
            ...
            /// </returns>
            public DateTime AddWeeks(Int32 value)
            {
            ...
            /// <returns></returns>
            public DateTime Add(ScheduleInterval scheduleInterval, Int32 interval, TimeSpan startTime)
            {
            ...
            /// <returns></returns>
            public DateTime Add(TimeWindow workingTimeWindow, TimeSpan duration)
            {
                DateTime retVal = currentValue;
            ...
            /// <param name="interval">Value to add to <paramref name="currentValue"/></param>
            /// <returns></returns>
            public DateTime Add(DatePeriod datePeriod, Int32 interval)
            {
