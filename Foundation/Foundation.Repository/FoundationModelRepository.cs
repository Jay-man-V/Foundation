...
namespace Foundation.Repository
{
        ...
        where TModel : IFoundationModel
    {
        ...
        )
        {
            ...
            _entityInsertParametersSection = String.Empty;
            _entityInsertParametersSection = String.Empty;
            _entityUpdateColumnParameters = String.Empty;
        ...
        protected virtual void AddParameter(PropertyInfo propertyInfo, DatabaseParameters databaseParameters, String columnName, TModel entity)
        {
            ...
            else if (propertyInfo.PropertyType == typeof(Double)) databaseParameters.Add(FoundationDataAccess.CreateParameter(columnName, propertyInfo.GetValue(entity), DataHelpers.DefaultDecimal));
            else if (propertyInfo.PropertyType == typeof(Decimal)) databaseParameters.Add(FoundationDataAccess.CreateParameter(columnName, propertyInfo.GetValue(entity), DataHelpers.DefaultDecimal));
            else if (propertyInfo.PropertyType == typeof(UInt64)) databaseParameters.Add(FoundationDataAccess.CreateParameter(columnName, propertyInfo.GetValue(entity), DataHelpers.DefaultUInt64));
            else if (propertyInfo.PropertyType == typeof(Int64)) databaseParameters.Add(FoundationDataAccess.CreateParameter(columnName, propertyInfo.GetValue(entity), DataHelpers.DefaultInt64));
            else if (propertyInfo.PropertyType == typeof(UInt32)) databaseParameters.Add(FoundationDataAccess.CreateParameter(columnName, propertyInfo.GetValue(entity), DataHelpers.DefaultUInt32));
            else if (propertyInfo.PropertyType == typeof(Int32)) databaseParameters.Add(FoundationDataAccess.CreateParameter(columnName, propertyInfo.GetValue(entity), DataHelpers.DefaultInt32));
            else if (propertyInfo.PropertyType == typeof(Int16)) databaseParameters.Add(FoundationDataAccess.CreateParameter(columnName, propertyInfo.GetValue(entity), DataHelpers.DefaultInt16));
            else if (propertyInfo.PropertyType == typeof(UInt16)) databaseParameters.Add(FoundationDataAccess.CreateParameter(columnName, propertyInfo.GetValue(entity), DataHelpers.DefaultUInt16));
            ...
            else if (propertyInfo.PropertyType == typeof(PostCode)) databaseParameters.Add(FoundationDataAccess.CreateParameter(columnName, (PostCode?)propertyInfo.GetValue(entity)));
            else if (propertyInfo.PropertyType == typeof(TelephoneNumber)) databaseParameters.Add(FoundationDataAccess.CreateParameter(columnName, (TelephoneNumber?)propertyInfo.GetValue(entity)));
        ...
        protected virtual PropertyInfo[] EntityProperties
        {
            get
            {
                if (_entityProperties == null || _entityProperties.Length == 0)
                {
                    ...
                    TModel instance = Core.IoC.Get<TModel>();
        ...
        protected virtual TModel? Get<TIdType>(TIdType tEntityId)
        {
            ...
            {
                String message = $"Unable to create Data Parameter for '{typeof(TIdType)}' with value '{tEntityId}'";
                throw new ArgumentNullException(nameof(dataParameter), message);
            }

            DatabaseParameters databaseParameters = [dataParameter];
        ...
        protected virtual TType PopulateEntity<TType>(DataRow dataRow) where TType : IFoundationModel
        {
            ...
            TType retVal = Core.IoC.Get<TType>();
        ...
        protected void MapStandardProperties(IFoundationModel entity, DataRow dataRow)
        {
            ...
            entity.Timestamp = DataHelpers.GetValue(dataRow[FDC.FoundationEntity.Timestamp], [ 0 ]);
