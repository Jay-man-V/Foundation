...
namespace Foundation.Tests.Unit.Foundation.ViewModels.BaseClasses
{
        ...
        where TBusinessProcess : ICommonBusinessProcess<TModel>
    {
        ...
        protected virtual String ExpectedScreenTitle { get; set; } = String.Empty;
        ...
        public void Test_BaseClassProperties()
        {
            ...
            Assert.That(TheGenericDataGridViewModel.FormTitle, Is.EqualTo(ExpectedScreenTitle));
        ...
        public void Test_Filter1SelectionChanged()
        {
            ...
            TheGenericDataGridViewModel!.Filter1SelectionChangedCommand.Execute(new Object());
        }
        ...
        public void Test_Filter2SelectionChanged()
        {
            ...
            TheGenericDataGridViewModel!.Filter2SelectionChangedCommand.Execute(new Object());
        }
        ...
        public void Test_Filter3SelectionChanged()
        {
            ...
            TheGenericDataGridViewModel!.Filter3SelectionChangedCommand.Execute(new Object());
        }
        ...
        public void Test_Filter4SelectionChanged()
        {
            ...
            TheGenericDataGridViewModel!.Filter4SelectionChangedCommand.Execute(new Object());
        }
        ...
        public void Test_GridExportColumns()
        {
            List<IGridColumnDefinition> expectedGridColumnDefinitions =
            [
                CoreInstance.IoC.Get<IGridColumnDefinition>(),
            ];
            BusinessProcess.GetColumnDefinitions().Returns(expectedGridColumnDefinitions);
