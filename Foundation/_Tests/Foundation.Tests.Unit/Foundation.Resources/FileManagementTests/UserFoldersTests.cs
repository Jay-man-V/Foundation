...
{
    /// <summary>
    /// Unit Tests for the User Folders class
    /// </summary>
    [TestFixture]
    public class UserFoldersTests : UnitTestBase
    {
        /// <summary>
        /// This test exists to force developers to come to this class if there are any changes to the <see cref="UserFolders"/>
        /// </summary>
        [TestCase]
        public void Test_CountMembers()
        {
            ...
            Type theType = typeof(UserFolders);
        ...
        /// </summary>
        [TestCase]
        public void Test_MyDocuments()
        {
            String expected = @"C:\Users\jayes\OneDrive\Documents";
            String actual = UserFolders.MyDocuments;
        ...
        {
            String expected = @"C:\Users\jayes\AppData\Local\Temp";
            String actual = UserFolders.TempDirectory;
