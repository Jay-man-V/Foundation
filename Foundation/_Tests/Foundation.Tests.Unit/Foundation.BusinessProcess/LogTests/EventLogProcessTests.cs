...
namespace Foundation.Tests.Unit.Foundation.BusinessProcess.LogTests
{
    ...
    public class EventLogProcessTests : CommonBusinessProcessTests<IEventLog, IEventLogProcess, IEventLogRepository>
    {
        ...
        protected override IEventLogProcess CreateBusinessProcess(IDateTimeService dateTimeService)
        {
            ...
            IEventLogProcess process = new EventLogProcess(CoreInstance, RunTimeEnvironmentSettings, dateTimeService, LoggingService, TheRepository!, StatusRepository!, UserProfileRepository!,  ReportGenerator!, logSeverityProcess, taskStatusProcess);
        ...
        protected override String GetCsvSampleData()
        {
            ...
            retVal += "Id,Created By,Created On,Updated By,Updated On,Parent Id,Log Severity,Batch Name,Process Name,Task Name,Task Status,Information" + Environment.NewLine;
            retVal += "1,0,2022-11-28T13:11:54.300,0,0001-01-01T00:00:00.000,1,1,e2b0b601-6929-4408-ab4d-84caf3730e92,b5fabecb-f5a1-4f42-bc49-798fc72933ce,4cbc495e-22c7-471c-8fe5-526ea894f6d0,1,21c2aec4-b4d5-415c-9293-886d574d0702" + Environment.NewLine;
            retVal += "2,0,2022-11-28T13:11:54.300,0,0001-01-01T00:00:00.000,1,1,618a7534-d2bf-444d-9532-496ee5128645,ea21b7f9-599c-4175-a186-da173b1da5f2,5b607aa7-476c-4f53-9fbc-b547e10f2cfd,1,93c582df-943e-463c-8e49-ea713bbd8fc6" + Environment.NewLine;
            retVal += "3,0,2022-11-28T13:11:54.300,0,0001-01-01T00:00:00.000,1,1,6a2571cb-887d-44f2-8b98-e548dbb5f9aa,efb7cb99-8b53-417d-9bef-c45ebe1e4a87,cee19a79-5230-4e32-98a9-fae4a9ae98bf,1,dd0e8c51-f568-4d9b-b0a1-a31f620c50f5" + Environment.NewLine;
            retVal += "4,0,2022-11-28T13:11:54.300,0,0001-01-01T00:00:00.000,1,1,f6a47492-49e5-43e5-9a42-7158e973676d,93f136f3-4077-4d81-9924-dc8e6b27e6cd,90c84f35-c2b3-45cd-9b96-9b61424b849c,1,af1b3628-3c3a-4e3f-b2b4-f61a819f8855" + Environment.NewLine;
            retVal += "5,0,2022-11-28T13:11:54.300,0,0001-01-01T00:00:00.000,1,1,592e76a8-10e5-45d9-8e40-43ed7578a961,17ccc55e-ddb4-44cf-a955-6d540d123c33,4bbee387-2d5b-4893-9140-dcf24b5f8d86,1,5413bd3b-c888-484f-99d5-62ac752c996d" + Environment.NewLine;
            retVal += "6,0,2022-11-28T13:11:54.300,0,0001-01-01T00:00:00.000,1,1,d2a545fd-419b-48e0-b79b-266d2b6d450c,5ed77477-e328-4c84-9374-2dee52c637e9,428b61ae-592e-47ae-afb6-1e11a0d4f2fd,1,b28583bd-6a96-43a9-8f77-7a20be94a399" + Environment.NewLine;
            retVal += "7,0,2022-11-28T13:11:54.300,0,0001-01-01T00:00:00.000,1,1,2ca607dc-3bcb-43d0-b0c5-95d8133c7a36,bc9dc450-e10a-41bb-9aba-2cfd145b8766,840eb984-d469-47cd-b5e9-69ff659a214e,1,0972b961-b6f1-4168-9a2d-e49573fca10b" + Environment.NewLine;
            retVal += "8,0,2022-11-28T13:11:54.300,0,0001-01-01T00:00:00.000,1,1,9e974881-0361-4551-9e91-1b138ae743b1,3641bac0-6663-49d7-9105-5d89f076756c,e31407d0-625d-4c36-9841-996ef26a39e5,1,3040976e-eab4-4e6b-ab75-08ba098b4049" + Environment.NewLine;
            retVal += "9,0,2022-11-28T13:11:54.300,0,0001-01-01T00:00:00.000,1,1,34d868f6-f1c4-4a40-9309-a01efc3de8d8,52812dfa-3a30-4aa2-97fc-f2de1e95d0c4,3ae4287d-6f52-42d0-abc8-9dbb497d74af,1,a9c39784-653a-490e-84dd-6fa6cf29e5b3" + Environment.NewLine;
            retVal += "10,0,2022-11-28T13:11:54.300,0,0001-01-01T00:00:00.000,1,1,38007a95-67a8-4260-8079-20d19eadcb0d,5e96476a-63a4-4a51-b973-bc2dd1fa63e2,29fe511f-0045-4559-af7b-0fbc974cf6a0,1,fdd5f618-5bc3-4e36-94d0-9a700c1378b9" + Environment.NewLine;
