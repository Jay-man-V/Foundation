...
namespace Foundation.Tests.Unit.Foundation.BusinessProcess.LogTests
{
    ...
    public class ImportExportControlProcessTests : CommonBusinessProcessTests<IImportExportControl, IImportExportControlProcess, IImportExportControlRepository>
    {
        ...
        {
            IImportExportControlProcess process = new ImportExportControlProcess(CoreInstance, RunTimeEnvironmentSettings, dateTimeService, TheRepository!, StatusRepository!, UserProfileRepository!);
        ...
        {
            IImportExportControl retVal = CoreInstance.IoC.Get<IImportExportControl>();
