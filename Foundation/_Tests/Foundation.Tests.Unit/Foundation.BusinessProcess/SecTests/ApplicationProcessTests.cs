...
namespace Foundation.Tests.Unit.Foundation.BusinessProcess.SecTests
{
    ...
    public class ApplicationProcessTests : CommonBusinessProcessTests<IApplication, IApplicationProcess, IApplicationRepository>
    {
        ...
        {
            IApplicationProcess process = new ApplicationProcess(CoreInstance, RunTimeEnvironmentSettings, dateTimeService, TheRepository!, StatusRepository!, UserProfileRepository!);
