...
namespace Foundation.Tests.Unit.Foundation.BusinessProcess.SecTests
{
    ...
    public class ApplicationProcessTests : CommonBusinessProcessTests<IApplication, IApplicationProcess, IApplicationRepository>
    {
        ...
        {
            IApplicationProcess process = new ApplicationProcess(CoreInstance, RunTimeEnvironmentSettings, dateTimeService, LoggingService, TheRepository!, StatusRepository!, UserProfileRepository!);
        ...
        {
            IApplication retVal = CreateBlankEntity(process, entityId);
