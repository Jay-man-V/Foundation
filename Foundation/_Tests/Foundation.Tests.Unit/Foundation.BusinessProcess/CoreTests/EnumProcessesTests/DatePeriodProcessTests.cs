//-----------------------------------------------------------------------
// <copyright file="DatePeriodProcessTests.cs" company="JDV Software Ltd">
...
{
    /// <summary>
    /// Summary description for DatePeriodProcessTests
    /// </summary>
    [TestFixture]
    public class DatePeriodProcessTests : CommonBusinessProcessTests<IDatePeriod, IDatePeriodProcess, IDatePeriodRepository>
    {
        protected override int ColumnDefinitionsCount => 10;
        protected override string ExpectedScreenTitle => "Date Periods";
        protected override string ExpectedStatusBarText => "Number of Date Periods:";

        protected override string ExpectedComboBoxDisplayMember => FDC.DatePeriod.Code;

        protected override IDatePeriodRepository CreateRepository()
        {
            IDatePeriodRepository retVal = Substitute.For<IDatePeriodRepository>();
        ...
        protected override IDatePeriodProcess CreateBusinessProcess(IDateTimeService dateTimeService)
        {
            IDatePeriodProcess process = new DatePeriodProcess(CoreInstance, RunTimeEnvironmentSettings, dateTimeService, LoggingService, TheRepository!, StatusRepository!, UserProfileRepository!,  ReportGenerator!);

            return process;
        }

        protected override IDatePeriod CreateBlankEntity(Int32 entityId)
        {
        ...
        protected override IDatePeriod CreateEntity(IDatePeriodProcess process, Int32 entityId)
        {
            IDatePeriod retVal = CreateBlankEntity(entityId);
        ...
        protected override void CheckBlankEntry(IDatePeriod entity)
        {
            Assert.That(entity.Code, Is.EqualTo(String.Empty));
        }

        protected override void CheckAllEntry(IDatePeriod entity)
        {
            Assert.That(entity.Code, Is.EqualTo(ExpectedAllText));
        }

        protected override void CheckNoneEntry(IDatePeriod entity)
        {
            Assert.That(entity.Code, Is.EqualTo(ExpectedNoneText));
        }

        protected override void CompareEntityProperties(IDatePeriod entity1, IDatePeriod entity2)
        {
        ...
        protected override void UpdateEntityProperties(IDatePeriod entity)
        {
