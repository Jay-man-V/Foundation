...
namespace Foundation.Tests.Unit.Foundation.BusinessProcess.CoreTests
{
    ...
    public class CurrencyProcessTests : CommonBusinessProcessTests<ICurrency, ICurrencyProcess, ICurrencyRepository>
    {
        ...
        {
            ICurrencyRepository retVal = Substitute.For<ICurrencyRepository>();
        ...
        {
            ICurrencyProcess process = new CurrencyProcess(CoreInstance, RunTimeEnvironmentSettings, dateTimeService, LoggingService, TheRepository!, StatusRepository!, UserProfileRepository!,  ReportGenerator!);

            return process;
        }

        protected override ICurrency CreateBlankEntity(Int32 entityId)
        {
        ...
        {
            ICurrency retVal = CreateBlankEntity(entityId);
