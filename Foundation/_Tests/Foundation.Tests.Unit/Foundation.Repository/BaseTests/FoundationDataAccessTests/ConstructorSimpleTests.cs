    ...
    public class ConstructorSimpleTests : UnitTestBase
    {
        ...
        public void Test_Constructor_Exception()
        {
            ...
            ArgumentNullException actualException = Assert.Throws<ArgumentNullException>(() =>
            {
                ...
                _ = new SimpleTestEntityRepository(CoreInstance!, RunTimeEnvironmentSettings, systemConfigurationService, dataProvider, DateTimeService);
            });
        ...
        public void Test_Constructor_MsSqlDataLogicProvider()
        {
            ...
            SimpleTestEntityRepository obj = new SimpleTestEntityRepository(CoreInstance!, RunTimeEnvironmentSettings, systemConfigurationService, dataProvider, DateTimeService);
