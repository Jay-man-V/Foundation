...
namespace Foundation.BusinessProcess.Sec
{
    ...
    public class ApplicationUserRoleProcess : CommonBusinessProcess<IApplicationUserRole, IApplicationUserRoleDataAccess>, IApplicationUserRoleProcess
    {
        ...
        {
            LoggingHelpers.TraceCallEnter(core, runTimeEnvironmentSettings, dateTimeService, loggingService, repository, statusRepository, userProfileRepository, reportGenerator, applicationProcess, roleProcess, userProfileProcess);
