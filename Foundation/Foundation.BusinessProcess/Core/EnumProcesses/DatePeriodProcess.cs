...
namespace Foundation.BusinessProcess.Core.EnumProcesses
{
    ...
    public class DatePeriodProcess : CommonBusinessProcess<IDatePeriod, IDatePeriodRepository>, IDatePeriodProcess
    {
        /// <summary>
        ...
        public override String ComboBoxDisplayMember => FDC.DatePeriod.Name;
        ...
        public override List<IGridColumnDefinition> GetColumnDefinitions()
        {
            ...
            gridColumnDefinition = new GridColumnDefinition(150, FDC.DatePeriod.Name, "Name", typeof(String));
            retVal.Add(gridColumnDefinition);

            gridColumnDefinition = new GridColumnDefinition(150, FDC.DatePeriod.Description, "Description", typeof(String));
            retVal.Add(gridColumnDefinition);
