//-----------------------------------------------------------------------
// <copyright file="ISaveFileDialogSettings.cs" company="JDV Software Ltd">
...
{
    /// <summary>
    /// The Save File Dialog model interface
    /// </summary>
    public interface ISaveFileDialogSettings
    {
        /// <summary>Gets or sets a value indicating whether [check path exists].</summary>
        /// <value>
