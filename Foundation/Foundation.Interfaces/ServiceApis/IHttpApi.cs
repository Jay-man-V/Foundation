//-----------------------------------------------------------------------
// <copyright file="IHttpApi.cs" company="JDV Software Ltd">
...
{
    /// <summary>
    /// Describes services for uploading and downloading files from a remote location using a Http method
    /// </summary>
    public interface IHttpApi : IRemoteServiceApi
    {
        /// <summary>
